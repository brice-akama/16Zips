...
export default function AboutPage() {
  ...
  />
        ...
        <div>
          <h1 className="text-3xl font-bold text-green-700 mb-4 md:mt-20">About 16Zips</h1>
          <p className="text-gray-600 text-lg">
            ...
            concentrates, or accessories, we’ve got it all. Our mission is to provide
...
<p className="text-gray-600">Join our newsletter and be the first to hear about exclusive offers, promotions, and more.</p>
