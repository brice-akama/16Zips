    ...
    <div className="p-4">
      ...
      <div className="text-center mb-8 px-4">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">
          Discover Our Collection of Buds
        </h1>
        <p className="text-gray-600 text-base md:text-lg max-w-2xl mx-auto">
          Explore our handpicked selection of premium buds, each carefully chosen for its unique effects and quality. Whether you're seeking relaxation, creativity, or balance, there's something perfect for you.
        </p>
      </div>
