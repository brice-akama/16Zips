        ...
        <div className="relative w-full aspect-square overflow-hidden bg-gray-50"> {/* 🎨 Subtle bg for image load */}
          <Link href={`/products/${product.slug}`} className="block h-full">
            <Image
              ...
              fill
              unoptimized
              className="object-cover bg-white transition-transform duration-500 group-hover:scale-105"
            />
          </Link>
            ...
            {!hovered ? (
              hasOptions ? (
                ...
                <motion.button
                  ...
                  className="bg-red-500 text-white whitespace-nowrap px-5 py-2.5 rounded-xl shadow-md hover:bg-red-600 transition-all duration-200 font-medium text-sm"
                >
                  Add to Cart
                </motion.button>
              )
